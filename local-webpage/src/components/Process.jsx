...
const steps = [
  {
    ...
    desc: '15-minute call. We learn about your trade, your market, and what you need. No pressure, no jargon.',
  },
  {
    num: '02',
    icon: Palette,
    title: 'Design & Build',
    desc: 'We design your site, you review it. One round of revisions included. Most sites done in 48 hours.',
  },
  {
    num: '03',
    icon: Rocket,
    title: 'Launch Day',
    desc: 'We handle hosting, domain, SSL, speed optimization — all the tech. You just approve and we go live.',
  },
  {
    num: '04',
    icon: TrendingUp,
    title: 'Grow & Dominate',
    desc: 'Ongoing SEO, monthly reports, and updates. Watch your phone ring more than it ever has.',
  },
]
