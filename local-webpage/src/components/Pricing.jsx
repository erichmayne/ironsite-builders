...
const plans = [
  {
    ...
    features: [
      'You own the site — full ownership',
  ...
  },
  {
    ...
    features: [
      'You own the site — full ownership',
      'Custom design tailored to your trade',
      'Unlimited revisions & changes, forever',
      'Ongoing SEO optimization & support',
  ...
  },
  {
    ...
    features: [
      'No upfront cost — just $50/mo',
      'Full-featured custom website',
      'Unlimited changes & content updates',
    ...
    <section id="pricing" className="relative py-24 sm:py-32">
      <div className="max-w-7xl mx-auto px-6">
            ...
            >
              ...
              <div className="p-8">
                ...
                <div className="flex items-baseline gap-1 mb-8">
                  <span className={`font-display text-5xl font-800 ${popular ? 'text-white' : 'text-gradient'}`}>
                    ${price}
                  </span>
                  ...
                  {features.map((feature) => (
                    <li key={feature} className="flex items-start gap-3">
                      <div className={`w-5 h-5 rounded-full flex-shrink-0 flex items-center justify-center mt-0.5 ${
                        popular ? 'bg-blue-400/30' : 'bg-blue-100'
                      }`}>
                ...
                <a
                  href="#contact"
                  className={`group/btn w-full flex items-center justify-center gap-2 px-6 py-3.5 rounded-full text-sm font-semibold transition-all duration-300 ${
                    popular
        ...
        <motion.p
          ...
          className="text-center text-sm text-blue-900/40 mt-8"
        >
