...
const testimonials = [
  ...
  {
    name: 'Sarah Kim',
    trade: 'Electrician, Bellevue',
    text: "They understood my business from the first call. No upselling, no BS. Site was live in 2 days and my Google rankings jumped within a month.",
    stars: 5,
    initials: 'SK',
  },
  {
    name: 'Marcus Johnson',
    trade: 'Roofer, Tacoma',
    text: "The before-and-after gallery they built for me does the selling on its own. I just point people to the site and the phone rings.",
    stars: 5,
    initials: 'MJ',
  },
  {
    name: 'Dave Castillo',
    trade: 'Handyman, Seattle',
    text: "I thought I didn't need a website — I was wrong. Online booking alone saved me 2 hours a day of back-and-forth phone calls.",
    stars: 5,
    initials: 'DC',
  },
]
    ...
    <section id="testimonials" className="relative py-24 sm:py-32 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          {testimonials.map(({ name, trade, text, stars, initials }, i) => (
            <motion.div
              key={name}
              initial={{ opacity: 0, y: 40 }}
              animate={inView ? { opacity: 1, y: 0 } : {}}
            ...
            >
              ...
              <p className="text-blue-900/70 leading-relaxed mb-6 relative z-10">"{text}"</p>
