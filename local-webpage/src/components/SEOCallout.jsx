          ...
          <div className="relative">
            <div className="rounded-2xl bg-white shadow-2xl shadow-blue-900/8 border border-eggshell-300/60 overflow-hidden">
              ...
              <div className="p-5 space-y-4">
                <div className="relative p-4 rounded-xl bg-blue-50/80 border-2 border-blue-300/50">
                ...
                {['CompetitorPlumbing.com', 'OtherGuyPlumbing.net'].map((name) => (
                  <div key={name} className="p-3 rounded-lg opacity-40">
            ...
            <div className="absolute -bottom-6 right-2 sm:right-8 bg-white rounded-xl shadow-xl shadow-blue-900/10 border border-eggshell-300/60 px-4 sm:px-5 py-3">
